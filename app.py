...
def main():
    st.title("Airfare Predictor")
    st.text("A Web-app which helps you to predict your flight price based on your wish")
    ...
    if dep is not None:
        ...
        hour_1 = st.sidebar.selectbox("Hour", list(range(1,24)))
    ...
    if arr is not None:
        mon_a = arr.month
        day_a = arr.day
        hour_2 = st.sidebar.selectbox("Hour.", list(range(1,24)) ,2)
